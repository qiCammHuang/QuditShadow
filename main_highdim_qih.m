...
for rep = 1:L
    ...
    for Sample = Sample_list
        ...
        num_of_measurements_budget_py = py.int(Sample);
        ...
        basis_list_py = py.derandTools.derandomized_classical_shadow_qudit(all_observables_py, ...
            num_of_measurements_budget_py, system_size_py, pyargs('dim', dim_py));
        ...
        basis_list_py = py.derandTools.derandomized_classical_shadow_qudit(all_observables_py, ...
            num_of_measurements_budget_py, system_size_py, pyargs('dim', dim_py, 'local_bias', local_bias_py));
